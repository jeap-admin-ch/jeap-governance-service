...
class RestApiRelationWithoutPactImporterDisabledIT {

    @Autowired
    private ApplicationContext context;

    @Test
    void restApiRelationWithoutPactBeans_shouldNotExist_whenDisabled() {
        assertThat(context.getBeansOfType(RestApiRelationWithoutPactImporter.class)).isEmpty();
        assertThat(context.getBeansOfType(RestApiRelationWithoutPactComponentDeletionListener.class)).isEmpty();

        assertThat(context.getBeansOfType(ApiDocVersionImporter.class)).hasSize(1);
