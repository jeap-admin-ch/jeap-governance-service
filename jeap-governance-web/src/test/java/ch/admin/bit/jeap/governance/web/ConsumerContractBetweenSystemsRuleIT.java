...
@ActiveProfiles("component-cdc-contractbetweensystems-rule-it")
class ConsumerContractBetweenSystemsRuleIT extends GovernanceIntegrationTestBase {
    ...
    void componentWithoutRestApiRelationWithoutPact_resultsInOk() {
        ...
        var ruleState = ruleStateRepository.findBySystemComponentAndRuleId(component, RuleId.of("component-cdc-contractbetweensystems"));
    ...
    void componentWithRestApiRelationWithoutPact_resultsInFail() {
        ...
        var system2 = systemRepository.add(System.builder()
                .name("testsys2")
                .aliases(Set.of())
                .systemComponents(List.of(
        ...
        var component = system.getSystemComponents().getFirst();
        var otherComponent = system2.getSystemComponents().getFirst();
    ...
    void componentWithRestApiRelationWithoutPact_relationsAndServicesIgnored_resultsInOk() {
        ...
        var component = system.getSystemComponents().getFirst();
        var otherComponent = system2.getSystemComponents().getFirst();
        var otherComponent2 = system2.getSystemComponents().get(1);
        var otherComponent3 = system2.getSystemComponents().get(2);
        var otherComponent4 = system2.getSystemComponents().get(3);
