...
@ActiveProfiles("component-produces-signedmessages-rule-it")
class ComponentProducesSignedMessagesRuleIT extends GovernanceIntegrationTestBase {
    ...
    @Test
    void componentProducesSignedMessages_resultsInOk() {
        ...
        var ruleState = ruleStateRepository.findBySystemComponentAndRuleId(component, RuleId.of("component-produces-signedmessages"));
    ...
    @Test
    void componentProducesUnsignedMessages_resultsInFail() {
        var system = systemRepository.add(System.builder()
                .name("testsys2")
                .aliases(Set.of())
                .systemComponents(List.of(
