...
class DatabaseSchemaVersionDisabledIT {

    @Autowired
    private ApplicationContext context;

    @Test
    void databaseSchemaVersionBeans_shouldNotExist_whenDisabled() {
        assertThat(context.getBeansOfType(DatabaseSchemaVersionImporter.class)).isEmpty();
        assertThat(context.getBeansOfType(DatabaseSchemaVersionComponentDeletionListener.class)).isEmpty();
