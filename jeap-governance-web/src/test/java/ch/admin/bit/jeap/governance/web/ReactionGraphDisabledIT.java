...
class ReactionGraphDisabledIT {
    ...
    @Test
    void reactionGraphImportBeans_shouldNotExist_whenDisabled() {
        assertThat(context.getBeansOfType(ReactionGraphImporter.class)).isEmpty();
        assertThat(context.getBeansOfType(ReactionGraphComponentDeletionListener.class)).isEmpty();
