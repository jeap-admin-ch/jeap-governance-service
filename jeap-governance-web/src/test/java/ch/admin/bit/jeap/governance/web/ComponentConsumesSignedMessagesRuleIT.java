...
@ActiveProfiles("component-consumes-signedmessages-rule-it")
class ComponentConsumesSignedMessagesRuleIT extends GovernanceIntegrationTestBase {
    ...
    @Test
    void componentConsumesSignedMessages_resultsInOk() {
        ...
        var ruleState = ruleStateRepository.findBySystemComponentAndRuleId(component, RuleId.of("component-consumes-signedmessages"));
    ...
    @Test
    void componentConsumesUnsignedMessages_resultsInFail() {
        var system = systemRepository.add(System.builder()
                .name("testsys2")
                .aliases(Set.of())
                .systemComponents(List.of(
        ...
        promTimeSeriesRepository.saveAll(List.of(
                PromTimeSeries.builder()
                        ...
                        .sample(new PromTimeSeriesSample(Map.of("service2", "bar"), List.of("0")))
                        .build(),
                PromTimeSeries.builder()
