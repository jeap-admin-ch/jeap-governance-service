...
class ConsumerContractBetweenSystemsRuleTest {

    @Mock
    private RestApiRelationWithoutPactRepository restApiRelationWithoutPactRepository;

    @InjectMocks
    private ConsumerContractBetweenSystemsRule rule;
    ...
    void metadata() {
        ...
        assertThat(metadata.ruleId().id()).isEqualTo("component-cdc-contractbetweensystems");
        assertThat(metadata.label()).isEqualTo("Consumer Contract Between Systems");
    }
    ...
    @Test
    void restRelationWithoutPact_servicesWithinSystem_ruleStateIsOk() {
        //given
    ...
    @Test
    void restRelationWithoutPact_servicesBetweenSystems_ruleStateIsFail() {
        //given
    ...
    void restRelationWithoutPact_providerServiceIsIgnored_ruleStateIsOk() {
        //given
        SystemComponent component = createComponent(1L, "test", mock(System.class));
        SystemComponent otherComponent1 = createComponent(2L, "otherComponent1", mock(System.class));
        SystemComponent otherComponent2 = createComponent(3L, "otherComponent2", mock(System.class));
        List<RestApiRelationWithoutPact> restRelationsWithoutPact = List.of(
